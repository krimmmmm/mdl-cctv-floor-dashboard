          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <StepProgressPanel
              ...
              steps={[
                ...
                {
                  title: "UPS",
                  subTitle: "UPS installed",
                  progress: averageProgress(safeRacks, "upsProgress"),
                  checked: countByProgress(safeRacks, "upsProgress").completed,
                  total: safeRacks.length,
                },
                {
                  title: "READY",
                  ...
                  {equipmentRows.map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="p-3">
                          {row.typeKey === "rack" || row.typeKey === "cabinet" ? (
                            <StatusPill status={getStatus(Number(row.upsProgress || 0))} />
                          ) : (
